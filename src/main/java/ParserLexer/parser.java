  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		int cajaleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int cajaright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Object caja = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
...
ExpressionTree.checkExpressionType(symList.get(3), symList.get(0), symbols, symTabMgr);
		...
		int tamalesright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Object tamales = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = "<EXPR>" + (String)tamales + "</EXPR>";
		...
		Object expr_l = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = "<EXPR>" + (String)tamales + "</EXPR>" + (String)expr_l;
       ...
       BlockTree.processAssign((String)RESULT, symbols, symTabMgr);
		...
		Object stmt_l = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = (String)celebracionesnavidenas + (String)stmt_l ; 
		...
		int tamalesright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		Object tamales = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		RESULT = (String)mut + "<EXPR>" + (String)tamales + "</EXPR>";
		...
		int tamalesright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Object tamales = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = "<LOGIC><OP1>" + (String)an_expr + "</OP1><SYM>" +(String)sym + "</SYM><OP2>" + (String)tamales + "</OP2></LOGIC>";  
		...
		int tamalesright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		Object tamales = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = "<ARR_ELEM><ID>" + (String)id + "</ID><EXPR>" + (String)tamales + "</EXPR></ARR_ELEM>" ; 
		...
		Object devolverregalo = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = "<CALL>" + (String)devolverregalo + "</CALL>"; 
		...
		Object pelotasarbol = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = "<FUNC>" + (String)id + "</FUNC><ARGUMENTS>" + (String)pelotasarbol + "</ARGUMENTS>"; 
		...
		int arg_lright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Object arg_l = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = "<ARG>" + (String)tamales + "</ARG>" + (String)arg_l; 
